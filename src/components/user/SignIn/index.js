                    ...
                    <div className='card shadow'>
                        ...
                        <form className='mt-4'>
                            ...
                            <div className='form-group mt-5 mb-4 w-100'>
                                <Button className='btn btn-g btn-lg w-100' onClick={()=>console.log('signIn')}>Sign In</Button>
                            </div>


                            <div className='form-group mt-5 mb-4 w-100 signInOr'>
                                <p className='text-center'>OR</p>
                                {/* <Button className='w-100' variant="outlined" onClick={()=>console.log('google')}><img src={GoogleImg} />
