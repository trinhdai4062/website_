                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                <Link to='/'><img src={require('../../../assets/images/logo_background.png')} style={{height:300,width:300}} /></Link>
                                <br />

                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: 521-Bắc Giang</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+84) - 0384199978 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> dai6dk9cntt@gmail.com</p>
